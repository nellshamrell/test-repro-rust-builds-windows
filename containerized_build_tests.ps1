...
function RLibTests { 
    ...
    # Write results to file
    "RLib Test Results`n-------------`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "Tested using https://github.com/microsoft/windows-rs/tree/master/crates/libs/windows`n"  | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "libwindows.d reproducible? ${DReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "libwindows.rlib reproducible? ${RLibReproducible}`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
...
function StaticCdyLibTests {
    ...
    # Write results to file
    "StaticLib/Cdy LibTest Results`n-------------`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "Tested using https://github.com/rust-lang/regex/tree/b92ffd5471018419ec48dbdef32757424439f065/regex-capi"  | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.d reproducible? ${DReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.dll reproducible? ${DllReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.dll.exp reproducible? ${DllExpReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.dll.lib reproducible? ${DllLibReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.lib reproducible? ${LibReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "rure.pdb reproducible? ${PdbReproducible}`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
...
function DyLibTests {
    ...
    # Write results to file
    "DyLib Test Results`n-------------`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "Tested using https://github.com/AndrewGaspar/rust-plugin-example/tree/master/plugin_a"  | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "plugin_a.d reproducible? ${DReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "plugin_a.dll reproducible? ${DllReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "plugin_a.dll.exp reproducible? ${DllExpReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "plugin_a.dll.lib reproducible? ${DllLibReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "plugin_a.pdb reproducible? ${PdbReproducible}`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
...
function ProcMacroTests {
    ...
    # Write results to file
    "Proc-Macro Test Results`n-------------`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "Tested using https://github.com/dtolnay/proc-macro-workshop/tree/master/seq"  | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "seq.d reproducible? ${DReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "seq.dll reproducible? ${DllReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "seq.dll.exp reproducible? ${DllExpReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "seq.dll.lib reproducible? ${DllLibReproducible}" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
    "seq.pdb reproducible? ${PdbReproducible}`n" | Out-File -FilePath ..\..\containerized_build_test_results.txt -Append
...
# Required on my system to let resources free up
Start-Sleep -s 30
